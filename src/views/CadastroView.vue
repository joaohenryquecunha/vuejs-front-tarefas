        ...
        <div class="container">
            <div class="box-inputs">
                <form @submit.prevent="cadastro">
                    ...
                    <input type="name" id="name" placeholder="Digite seu nome" v-model="name" required>
                    ...
                    <div class="botao-submit">
                        <p @click="redirectToLogin" class="link" >Já tenho conta</p>
                        <button type="submit">Cadastrar</button>
                    </div>
                </form>
            </div>
            <div class="box-cadastro-text">
                <h1 class="emotion">🤘</h1>
                <p class="cadastro-text-paragraph">A fortuna fica ao lado daquele que ousa.</p>
                <span class="cadastro-text-span">Todo progresso ocorre fora da zona de conforto.</span>
                <div class="box-cadastro-inferior">
                    <div class="box-left">
...
export default {
    ...
    methods: {
        async cadastro() {
            try {
                const response = await this.$axios.post('cadastro', {
                    name: this.name,
                    email: this.email,
